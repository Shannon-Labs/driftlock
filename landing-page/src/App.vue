        ...
        <div class="flex items-center justify-between h-20">
          <router-link to="/" class="flex items-center space-x-3">
            ...
            <div class="flex-shrink-0">
                <img src="/logo.svg" alt="Driftlock Logo" class="h-8 w-auto">
            </div>
            <span class="text-xl font-extrabold font-mono text-gray-900 dark:text-white">Driftlock</span>
          </router-link>
    ...
    <footer class="bg-white border-t border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        <div class="container-padding mx-auto py-12">
            <div class="flex flex-col items-center justify-between md:flex-row">
                ...
                <p class="mt-4 text-sm text-gray-600 dark:text-gray-400 md:mt-0">
                    © 2025 Shannon Labs. Licensed under Apache 2.0.
                </p>
                <div class="mt-4 flex space-x-6 md:mt-0">
                    <a href="https://github.com/Shannon-Labs/driftlock" class="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300">
