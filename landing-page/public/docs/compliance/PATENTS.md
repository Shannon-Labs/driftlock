# Driftlock Patent Notice

## Patent Status

Driftlock's compression-based anomaly detection technology is **patent-pending**.

### United States Patent Application
- **Title:** Compression-Based Anomaly Detection with Format-Aware Compression Framework
- **Application Number:** Pending
- **Filing Date:** 2024
- **Assignee:** Shannon Labs, LLC
...
Except as expressly provided herein, no other rights or licenses are granted. All rights not expressly granted are reserved by Shannon Labs.
