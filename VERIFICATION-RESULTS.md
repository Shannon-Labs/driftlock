...
- Detection rate: ~1.5% of processed events (30/2000)
...
- For each anomaly:
  - Compression distance, statistical significance, confidence scores
  - Baseline Comparison table: timing patterns, amount ratios, endpoint/origin frequencies
  - Similar normal examples from the warmup window

## Implementation notes

- Two-stage flow: warmup builds baseline; detection runs every N=25 events
- Rust FFI API provides detection and analysis functions
