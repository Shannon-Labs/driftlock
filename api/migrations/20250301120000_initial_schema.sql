...
-- +goose Down
DROP INDEX IF EXISTS export_jobs_tenant_idx;
DROP TABLE IF EXISTS export_jobs;

DROP INDEX IF EXISTS anomaly_evidence_anomaly_idx;
DROP TABLE IF EXISTS anomaly_evidence;

DROP INDEX IF EXISTS anomalies_lookup_idx;
DROP TABLE IF EXISTS anomalies;

DROP INDEX IF EXISTS ingest_batches_stream_idx;
