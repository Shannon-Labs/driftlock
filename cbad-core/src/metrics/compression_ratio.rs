...
mod tests {
    ...
    fn test_anomalous_data_compression() {
        ...
        println!("Baseline: {:.2}x, Window: {:.2}x, Change: {:.1}%", 
    ...
    fn test_otlp_log_compression() {
        ...
        let multi_ratio = calculate_single_compression_ratio(multiple_logs.as_bytes(), adapter.as_ref())
        ...
        assert!(multi_ratio > ratio, "Multiple similar logs should compress better than single log");
    }
}
